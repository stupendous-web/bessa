      ...
      <div className={"uk-section"}>
        <div className={"uk-container"}>
          ...
          <p>
            ...
            comprised of various web pages operated by Bessa. Bessa is offered
            to you conditioned on your acceptance without modification of the
            terms, conditions, and notices contained herein (the
            &quot;Terms&quot;). Your use of Bessa constitutes your agreement to
          ...
          <p>
            ...
            entity. You acknowledge that Bessa is not responsible for third
            party access to your account that results from theft or
            misappropriation of your account. Bessa and its associates reserve
          ...
          <p>
            Bessa may contain links to other websites (&quot;Linked
            Sites&quot;). The Linked Sites are not under the control of Bessa
            and Bessa is not responsible for the contents of any Linked Site,
            including without limitation any link contained in a Linked Site, or
            any changes or updates to a Linked Site. Bessa is providing these
            links to you only as a convenience, and the inclusion of any link
            does not imply endorsement by Bessa of the site or any association
            with its operators.
          </p>
          <p>
            Certain services made available via Bessa are delivered by third
            party sites and organizations. By using any product, service or
            functionality originating from the Bessa domain, you hereby
            acknowledge and consent that Bessa may share such information and
            data with any third party with whom Bessa has a contractual
            relationship to provide the requested product, service or
            functionality on behalf of Bessa users and customers.
          </p>
          <h2>No Unlawful or Prohibited Use/Intellectual Property</h2>
          <p>
            You are granted a non-exclusive, non-transferable, revocable license
            to access and use Bessa strictly in accordance with these terms of
            use. As a condition of your use of the Site, you warrant to Bessa
          ...
          <p>
            ...
            used on the Site, is the property of Bessa or its suppliers and
          ...
          <p>
            ...
            the Site. Bessa content is not for resale. Your use of the Site does
            ...
            Bessa and the copyright owner. You agree that you do not acquire any
            ownership rights in any protected content. We do not grant you any
            licenses, express or implied, to the intellectual property of Bessa
          ...
          <p>
            Bessa has no obligation to monitor the Communication Services.
            However, Bessa reserves the right to review materials posted to a
            Communication Service and to remove any materials in its sole
            discretion. Bessa reserves the right to terminate your access to any
            or all of the Communication Services at any time without notice for
            any reason whatsoever.
          </p>
          <p>
            Bessa reserves the right at all times to disclose any information as
            ...
            information or materials, in whole or in part, in Bessa&apos;s sole
            discretion.
          </p>
          <p>
            ...
            Service. Bessa does not control or endorse the content, messages or
            information found in any Communication Service and, therefore, Bessa
            ...
            not authorized Bessa spokespersons, and their views do not
            necessarily reflect those of Bessa.
          </p>
          <p>
          ...
          <h2>Materials Provided to Bessa or Posted on Any Bessa Web Page</h2>
          <p>
            Bessa does not claim ownership of the materials you provide to Bessa
            (including feedback and suggestions) or post, upload, input or
            submit to any Bessa Site or our associated services (collectively
            &quot;Submissions&quot;). However, by posting, uploading, inputting,
            providing or submitting your Submission you are granting Bessa, our
            affiliated companies and necessary sublicensees permission to use
          ...
          <p>
            ...
            Submission, as provided herein. Bessa is under no obligation to post
            or use any Submission you may provide and may remove any Submission
            at any time in Bessa&apos;s sole discretion.
          </p>
          <p>
          ...
          <p>
            The Service is controlled, operated and administered by Bessa from
            ...
            all local laws. You agree that you will not use the Bessa Content
            accessed through Bessa in any country or in any manner prohibited by
            any applicable laws, restrictions or regulations.
          </p>
          <h2>Indemnification</h2>
          <p>
            You agree to indemnify, defend and hold harmless Bessa, its
            ...
            laws, rules or regulations. Bessa reserves the right, at its own
            ...
            fully cooperate with Bessa in asserting any available defenses.
          </p>
          <h2>Arbitration</h2>
          <p>
          ...
          <p>
            ...
            AGAINST THE OTHER. Further, unless both you and Bessa agree
          ...
          <p>
            ...
            BESSA AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
            THE SITE AT ANY TIME.
          </p>
          <p>
            BESSA AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
            ...
            IS&quot; WITHOUT WARRANTY OR CONDITION OF ANY KIND. BESSA AND/OR ITS
          ...
          <p>
            ...
            BESSA AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
            ...
            STRICT LIABILITY OR OTHERWISE, EVEN IF BESSA OR ANY OF ITS SUPPLIERS
          ...
          <p>
            Bessa reserves the right, in its sole discretion, to terminate your
            ...
            this agreement is governed by the laws of the State of Nevada and
            you hereby consent to the exclusive jurisdiction and venue of courts
            in Nevada in all disputes arising out of or relating to the use of
          ...
          <p>
            ...
            relationship exists between you and Bessa as a result of this
            agreement or use of the Site. Bessa&apos;s performance of this
            agreement is subject to existing laws and legal process, and nothing
            contained in this agreement is in derogation of Bessa&apos;s right
            ...
            provided to or gathered by Bessa with respect to such use. If any
          ...
          <p>
            ...
            entire agreement between the user and Bessa with respect to the Site
            ...
            Bessa with respect to the Site. A printed version of this agreement
          ...
          <p>
            Bessa reserves the right, in its sole discretion, to change the
            Terms under which Bessa is offered. The most current version of the
            Terms will supersede all previous versions. Bessa encourages you to
